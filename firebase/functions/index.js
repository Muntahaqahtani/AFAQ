...
function getDocIdBound(index, numBatches) {
  ...
  return "Account/" + firstChar + secondChar;
}
...
const kStripeTestSecretKey =
  "sk_test_51QHb3kERVhtOCbyk8aXMdl0TyWCRxygFi1uqmUDQNfvOoDRA0RWowRNhVOVa2uCIS6rQUerBG9gYeGtcUndVGUFu00pWOmHcyd";
...
exports.onUserDeleted = functions.auth.user().onDelete(async (user) => {
  ...
  let userRef = firestore.doc("Account/" + user.uid);
  await firestore.collection("Account").doc(user.uid).delete();
});
