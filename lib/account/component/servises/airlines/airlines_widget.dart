...
export 'airlines_model.dart';

class AirlinesWidget extends StatefulWidget {
  const AirlinesWidget({super.key});

  @override
  State<AirlinesWidget> createState() => _AirlinesWidgetState();
}

class _AirlinesWidgetState extends State<AirlinesWidget>
    with TickerProviderStateMixin {
  late AirlinesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AirlinesModel());
