...
import 'lounges_model.dart';
export 'lounges_model.dart';

class LoungesWidget extends StatefulWidget {
  const LoungesWidget({super.key});

  @override
  State<LoungesWidget> createState() => _LoungesWidgetState();
}

class _LoungesWidgetState extends State<LoungesWidget>
    with TickerProviderStateMixin {
  late LoungesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoungesModel());
