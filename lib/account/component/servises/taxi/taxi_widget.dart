...
class TaxiWidget extends StatefulWidget {
  const TaxiWidget({super.key});

  @override
  State<TaxiWidget> createState() => _TaxiWidgetState();
}

class _TaxiWidgetState extends State<TaxiWidget> with TickerProviderStateMixin {
  late TaxiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaxiModel());
