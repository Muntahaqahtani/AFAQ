...
import 'telecom_services_model.dart';
export 'telecom_services_model.dart';

class TelecomServicesWidget extends StatefulWidget {
  const TelecomServicesWidget({super.key});

  @override
  State<TelecomServicesWidget> createState() => _TelecomServicesWidgetState();
}

class _TelecomServicesWidgetState extends State<TelecomServicesWidget>
    with TickerProviderStateMixin {
  late TelecomServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelecomServicesModel());
