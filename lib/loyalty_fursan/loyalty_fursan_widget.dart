...
import 'loyalty_fursan_model.dart';
export 'loyalty_fursan_model.dart';

class LoyaltyFursanWidget extends StatefulWidget {
  /// view and add loyalty points
  const LoyaltyFursanWidget({super.key});

  @override
  State<LoyaltyFursanWidget> createState() => _LoyaltyFursanWidgetState();
}

class _LoyaltyFursanWidgetState extends State<LoyaltyFursanWidget> {
  late LoyaltyFursanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoyaltyFursanModel());
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Add Your Saudia Airline Membership Points',
