...
import 'rescheduledreslt_model.dart';
export 'rescheduledreslt_model.dart';

class RescheduledresltWidget extends StatefulWidget {
  const RescheduledresltWidget({
    super.key,
    this.origin,
    this.destination,
    this.depDate,
  ...
  @override
  State<RescheduledresltWidget> createState() => _RescheduledresltWidgetState();
}

class _RescheduledresltWidgetState extends State<RescheduledresltWidget> {
  late RescheduledresltModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RescheduledresltModel());
                  ...
                  builder: (context, snapshot) {
                    ...
                    return InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (!((_model.searchsuccess11 != null &&
                                (_model.searchsuccess11)!.isNotEmpty) ||
                            (_model.searchsuccess12 != null &&
                                (_model.searchsuccess12)!.isNotEmpty) ||
                            (_model.searchsuccess13 != null &&
                                (_model.searchsuccess13)!.isNotEmpty))) {
                          await showModalBottomSheet(
                            isScrollControlled: true,
                            backgroundColor: Colors.transparent,
                            enableDrag: false,
